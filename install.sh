...
# oh-my-zsh & plugins
curl -fsSL https://github.com/robbyrussell/oh-my-zsh/raw/master/tools/install.sh | sh
...
sh -c "$(curl -fsSL https://raw.githubusercontent.com/deluan/zsh-in-docker/master/zsh-in-docker.sh)" -- -t agnoster
